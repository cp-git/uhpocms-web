...
export class AppService {
  ...
  fetchAllInstitution(): Observable<any> {
    ...
    return this._http.get<any>(
      this.baseUrl + this.adminInstitutionWar + this.adminInstitutionURL
    );
  }
  ...
  fetchAllCourses(): Observable<Course[]> {
    ...
    return this._http.get<Course[]>(
      this.baseUrl + this.courseWar + this.courseURL
    );
  }
  ...
  fetchAllCategories(): Observable<Category[]> {
    ...
    return this._http.get<Category[]>(
      this.baseUrl + this.categoryWar + this.categoryURL
    );
  }

  fetchAllModules(): Observable<Module[]> {
    // alert(this.baseUrl + this.moduleWar + this.moduleURL)
    return this._http.get<Module[]>(
      this.baseUrl + this.moduleWar + this.moduleURL
    );
  }

  fetchAllInstituteProfile(): Observable<InstituteAdmin[]> {
    //alert(this.baseUrl + this.instituteProfileWar + this.instituteProfileURL)
    return this._http.get<InstituteAdmin[]>(
      this.baseUrl + this.instituteProfileWar + this.instituteProfileURL
    );
  }
}
